...
class Project(models.Model):
    ...
    image_one = models.ImageField(upload_to=unique_filename, blank=True, null=True, verbose_name=_("Image One"))
    image_two = models.ImageField(upload_to=unique_filename, blank=True, null=True, verbose_name=_("Image Two"))
    image_three = models.ImageField(upload_to=unique_filename, blank=True, null=True, verbose_name=_("Image Three"))
    image_four = models.ImageField(upload_to=unique_filename, blank=True, null=True, verbose_name=_("Image Four"))
    image_five = models.ImageField(upload_to=unique_filename, blank=True, null=True, verbose_name=_("Image Five"))
    image_six = models.ImageField(upload_to=unique_filename, blank=True, null=True, verbose_name=_("Image Six"))
    image_seven = models.ImageField(upload_to=unique_filename, blank=True, null=True, verbose_name=_("Image Seven"))
    image_eight = models.ImageField(upload_to=unique_filename, blank=True, null=True, verbose_name=_("Image Eight"))
