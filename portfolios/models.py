...
class Portfolio(models.Model):
    ...
    client_name = models.CharField(max_length=200, blank=True, null=True, verbose_name=_("Client Name"))
    client_testimonial = models.TextField(blank=True, null=True, verbose_name=_("Client Testimonial"))
    category = models.CharField(max_length=100, choices=[('Design', 'Design'), ('Development', 'Web Development'), ('App', 'Mobile App'), ('Other', 'Other')], verbose_name=_("Category"))
    status = models.CharField(max_length=20, choices=[('Completed', 'Completed'), ('In Progress', 'In Progress')], default='Completed', verbose_name=_("Project Status"))
    duration = models.CharField(max_length=50, blank=True, null=True, verbose_name=_("Project Duration"))
